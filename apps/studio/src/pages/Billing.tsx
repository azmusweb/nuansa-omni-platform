...
export const Billing: FC<{ currentPath: string, plan: string, transactions: any[] }> = ({ currentPath, plan = 'gratis', transactions = [] }) => {
 ...
 <h2 class="text-2xl font-bold text-[#161616] mb-2">Paket Langganan Anda</h2>
 ...
 <p class="text-xl font-bold text-[#161616] uppercase tracking-wider">{plan}</p>
 </div>
 </div>
 ...
 <h3 class="text-lg font-bold text-[#161616] mb-1">Paket Pro</h3>
 ...
 <button type="submit" class="w-full py-2 bg-gray-50 border border-slate-600 hover:border-brand-500 text-[#161616] rounded-lg font-medium text-sm transition" disabled={plan === 'pro' || plan === 'enterprise'}>
 ...
 <h3 class="text-lg font-bold text-[#161616] mb-1">Enterprise</h3>
 ...
 <h3 class="font-semibold text-[#161616]">Status Permintaan</h3>
 </div>
 <div class="p-0">
 ...
 <span class="text-sm font-medium text-[#161616]">{tx.type === 'plan_upgrade' ? 'Upgrade Paket' : tx.type}</span>
