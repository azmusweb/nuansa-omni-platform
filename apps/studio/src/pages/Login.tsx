...
export const Login: FC<{ error?: string }> = ({ error }) => {
 ...
 <input type="email" name="email" placeholder="admin@perusahaan.com" required class="w-full bg-white border border-[#ebebeb] rounded-xl px-4 py-3.5 focus:outline-none focus:border-brand-500 transition text-[#161616] placeholder-slate-500" />
 </div>
 <div>
 <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Kata Sandi</label>
 <input type="password" name="password" placeholder="••••••••" required class="w-full bg-white border border-[#ebebeb] rounded-xl px-4 py-3.5 focus:outline-none focus:border-brand-500 transition text-[#161616] placeholder-slate-500" />
 </div>
