      ...
      <div class="flex flex-col gap-6">
        ...
        <div class="bg-dark-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl shadow-xl flex flex-col overflow-hidden">
          ...
          <div class="p-4 border-b border-slate-700/50 shrink-0 bg-dark-900 flex justify-between items-center">
            <h3 class="text-white font-semibold flex items-center gap-2">
              <svg class="w-4 h-4 text-brand-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path></svg>
              Architect Panel
            </h3>
          </div>
          ...
          <form id="architect-form" action="/api/settings" method="POST" class="flex flex-col flex-1 overflow-hidden">
            ...
            <div class="flex-1 overflow-y-auto">
              ...
              <div class="flex text-xs font-medium text-slate-400 border-b border-slate-700/50 bg-dark-900 sticky top-0 z-10">
              ...
              <div class="p-5 space-y-6">
                ...
                <div class="mb-6 p-4 bg-dark-900 border border-brand-500/30 rounded-xl shadow-inner">
                  <label class="block text-brand-400 text-xs font-semibold uppercase tracking-wider mb-3 flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"></path></svg>
                    Preset Desain Instan
                  </label>
                  <div class="grid grid-cols-3 gap-2">
                    <button type="button" onclick="applyPreset('minimalis')" class="py-2 px-1 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-lg text-[10px] font-medium text-slate-300 transition">Minimalis</button>
                    <button type="button" onclick="applyPreset('korporat')" class="py-2 px-1 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-lg text-[10px] font-medium text-slate-300 transition">Korporat</button>
                    <button type="button" onclick="applyPreset('kreatif')" class="py-2 px-1 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-lg text-[10px] font-medium text-slate-300 transition">Kreatif</button>
                  </div>
                </div>
                ...
                <div id="panel-global" class="space-y-5 block">
                  <div>
                    <label class="block text-slate-300 text-xs font-semibold uppercase tracking-wider mb-2">Nama Identitas Situs</label>
                    <input 
                      type="text" 
                      name="siteName" 
                      id="input-siteName"
                      value={siteName}
                      class="w-full bg-dark-900 border border-slate-700 rounded-xl px-4 py-2.5 text-white text-sm focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition"
                      placeholder="Nuansa Web"
                    />
                  </div>

                  <div>
                    <label class="block text-slate-300 text-xs font-semibold uppercase tracking-wider mb-2">Warna Utama (Aksen)</label>
                    <div class="flex items-center gap-3">
                      ...
                      <input 
                        ...
                        value={primaryColor}
                        class="flex-1 bg-dark-900 border border-slate-700 rounded-lg px-3 py-2 font-mono text-sm text-slate-300 focus:outline-none focus:border-brand-500"
                  ...
                  <div>
                    <label class="block text-slate-300 text-xs font-semibold uppercase tracking-wider mb-2">Tipografi (Font Utama)</label>
                    <select name="fontFamily" id="input-fontFamily" class="w-full bg-dark-900 border border-slate-700 rounded-xl px-4 py-2.5 text-white text-sm focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition">
                ...
                <div id="panel-header" class="space-y-5 hidden">
                  <div>
                    <label class="block text-slate-300 text-xs font-semibold uppercase tracking-wider mb-3">Gaya Tata Letak Header</label>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                      <label class="relative cursor-pointer">
                        ...
                        <div class="p-3 bg-dark-900 border border-slate-700 rounded-xl peer-checked:border-brand-500 peer-checked:ring-1 peer-checked:ring-brand-500 transition opacity-60 peer-checked:opacity-100">
                          ...
                          <p class="text-xs text-center mt-2 font-medium text-slate-300">Logo Kiri</p>
                        </div>
                      </label>
                      <label class="relative cursor-pointer">
                        ...
                        <div class="p-3 bg-dark-900 border border-slate-700 rounded-xl peer-checked:border-brand-500 peer-checked:ring-1 peer-checked:ring-brand-500 transition opacity-60 peer-checked:opacity-100">
                          ...
                          <p class="text-xs text-center mt-2 font-medium text-slate-300">Logo Tengah</p>
                        </div>
                      </label>
                    </div>
                  </div>
                ...
                <div id="panel-footer" class="space-y-5 hidden">
                  <div>
                    <label class="block text-slate-300 text-xs font-semibold uppercase tracking-wider mb-3">Gaya Tata Letak Footer</label>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                      <label class="relative cursor-pointer">
                        ...
                        <div class="p-3 bg-dark-900 border border-slate-700 rounded-xl peer-checked:border-brand-500 peer-checked:ring-1 peer-checked:ring-brand-500 transition opacity-60 peer-checked:opacity-100">
                          ...
                          <p class="text-[10px] text-center mt-2 font-medium text-slate-300">Sederhana</p>
                        </div>
                      </label>
                      <label class="relative cursor-pointer">
                        ...
                        <div class="p-3 bg-dark-900 border border-slate-700 rounded-xl peer-checked:border-brand-500 peer-checked:ring-1 peer-checked:ring-brand-500 transition opacity-60 peer-checked:opacity-100">
                          ...
                          <p class="text-[10px] text-center mt-2 font-medium text-slate-300">3 Kolom</p>
                        </div>
                      </label>
                    </div>
                  </div>
            ...
            <div class="p-4 bg-dark-900 border-t border-slate-700/50 shrink-0">
        ...
        <div class="bg-dark-900 border border-slate-700/50 rounded-2xl shadow-2xl overflow-hidden flex flex-col min-h-[600px]">
          <div class="bg-dark-800 px-4 py-3 flex items-center justify-between border-b border-slate-700/50 shrink-0">
            ...
            <div class="px-8 py-1.5 bg-dark-900 text-slate-400 text-xs font-mono rounded-lg border border-slate-700/50 flex items-center gap-2">
          ...
          <div class="flex-1 bg-white relative overflow-y-auto" id="previewArea">
            ...
            <div id="mockup-site" class="min-h-full flex flex-col transition-all duration-300" style={`font-family: '${fontFamily}', sans-serif;`}>
              ...
              <div class="flex-1 flex flex-col items-center justify-center text-center px-4 py-20 bg-slate-50 relative overflow-hidden">
                ...
                <p class="text-lg text-slate-500 max-w-xl mb-10 relative z-10 leading-relaxed">Sistem manajemen konten kelas dunia yang memungkinkan Anda membangun kehadiran digital tanpa batas dengan performa Edge-Native.</p>
                <div class="flex gap-4 relative z-10">
                  <button class="px-8 py-3.5 rounded-full text-white font-medium shadow-xl hover:opacity-90 transition-all transform hover:-translate-y-1" style={`background-color: ${primaryColor}`} id="previewButton">
                    Mulai Eksplorasi
                  </button>
              ...
              {/* Dynamic Footer */}
              <footer id="mockup-footer" class={`bg-slate-900 text-slate-400 py-12 px-8 transition-all ${footerLayout === 'columns' ? '' : 'text-center'}`}>
                {footerLayout === 'columns' ? (
                  <div id="footer-cols" class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 max-w-5xl mx-auto border-b border-slate-800 pb-8">
                    <div>
                      <h4 class="text-white font-bold mb-4" style={`color: ${primaryColor}`} id="previewFooterLogo">{siteName}</h4>
      ...
      <script dangerouslySetInnerHTML={{__html: `
        ...
        function switchTab(tab) {
          ['global', 'header', 'footer', 'html'].forEach(t => {
            ...
            btn.classList.remove('text-white', 'border-b-2', 'border-brand-500');
          ...
          activeBtn.classList.add('text-white', 'border-b-2', 'border-brand-500');
        }
