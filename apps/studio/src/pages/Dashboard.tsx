...
export const Dashboard: FC<{ 
 ...
 <div class="bg-white backdrop-blur-sm border border-gray-200 p-6 rounded-2xl shadow-xl hover:bg-white transition group">
 ...
 <span class="text-3xl font-bold text-gray-900 font-mono">{metric.value}</span>
 ...
 <div class="lg:col-span-2 bg-white backdrop-blur-sm border border-gray-200 p-6 rounded-2xl shadow-xl min-h-[400px] flex flex-col items-center justify-center">
 <div class="w-16 h-16 rounded-full bg-brand-500/10 flex items-center justify-center mb-4 border border-gray-200">
 <svg class="w-8 h-8 text-brand-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
 </div>
 <p class="text-brand-600 font-bold font-mono uppercase tracking-wider">Grafik Analisis Lalu Lintas (Segera Hadir)</p>
 <p class="text-sm text-gray-400 mt-2 text-center max-w-sm">
 Data analitik edge-native akan divisualisasikan di sini.
 </p>
 </div>

 <div class="bg-white backdrop-blur-sm border border-gray-200 p-6 rounded-2xl shadow-xl">
 <h3 class="text-lg font-bold text-brand-600 mb-6 font-mono uppercase tracking-wider">&gt; Aktivitas_Terbaru</h3>
 <div class="space-y-6">
 {recentPosts.length === 0 ? (
 <p class="text-sm text-gray-400 font-mono">Belum ada aktivitas penulisan artikel.</p>
 ) : (
 ...
 <p class="text-xs text-gray-400 mt-1 font-mono">{formattedTime}</p>
 </div>
 </div>
 )
 })
 ...
 <div>
 <p class="text-sm text-gray-500 font-mono">Sistem Dasbor Dinamis diaktifkan</p>
 <p class="text-xs text-gray-400 mt-1 font-mono">Sistem Otomatis</p>
 </div>
 </div>
 </div>
 </div>
