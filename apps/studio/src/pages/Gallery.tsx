...
export const Gallery: FC<{ currentPath: string }> = ({ currentPath }) => {
 ...
 <div>
 <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight mb-2">Galeri Tema</h1>
 <p class="text-gray-500">Koleksi tema tersimpan Anda dan tema premium yang Anda beli dari Marketplace.</p>
 </div>
 <button class="px-5 py-2.5 bg-brand-600 hover:bg-brand-500 text-gray-900 text-sm font-medium rounded-xl transition shadow-lg shadow-brand-500/20">
 ...
 <h3 class="text-gray-900 font-semibold">Tema Minimalis Elegan</h3>
 ...
 <div class="p-5">
 <div class="flex items-center justify-between mb-2">
 <h3 class="text-gray-900 font-semibold">Korporat Premium</h3>
